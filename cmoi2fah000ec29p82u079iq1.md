---
title: "Canary on the Stack"
datePublished: 2026-04-28T03:27:29.992Z
cuid: cmoi2fah000ec29p82u079iq1
slug: canary-on-the-stack
...
![image](https://github.com/user-attachments/assets/14aa4de9-54fe-41f6-bf17-25b1e349331c align="center")
...
![image](https://github.com/user-attachments/assets/1cea7567-29a2-4aeb-ba26-a73cef0b47cf align="center")
...
![image](https://github.com/user-attachments/assets/ea4f1e90-5c5c-4364-8ba6-31c874339cb0 align="center")

![image](https://github.com/user-attachments/assets/87acc628-4285-411a-9f5c-d4e316d97c5b align="center")

![image](https://github.com/user-attachments/assets/8074a773-1c44-4d2f-9f7a-60e6a6e0d809 align="center")
...
![image](https://github.com/user-attachments/assets/ec3e0087-f4d4-4d4c-9353-679dc6c7071c align="center")
...
*   A vulnerability that might expose this bypass would include: Uncontrolled format strings, out-of-bounds array access, uninitialized memory usage, or type confusion. 2.) Target other variables instead
...
This is done so we can only focus on bypassing a stack canary. Figure 7 shows the program does have a canary enabled for the newly compiled program.

![image](https://github.com/user-attachments/assets/1bf83cfd-a5f4-4e46-95cf-19bbca6feeff align="center")

Figure 8 depicts the canary working with the Stack Smashing error.

![image](https://github.com/user-attachments/assets/98cf69df-8ee2-43fe-ad3c-acf1fc25fbb8 align="center")
...
![image](https://github.com/user-attachments/assets/836ccf23-0acc-4957-907f-94bcb09d67f4 align="center")
...
![image](https://github.com/user-attachments/assets/6c7f2bd6-5c16-4c1d-8cf8-420fd4259aca align="center")
...
![image](https://github.com/user-attachments/assets/7498b2ba-7e5c-44e6-83b1-5e278f7fe1b2 align="center")

This is much better and allows us to see the entire stack frame for the `main()` function. We can verify by seeing the point to rbp and the stack canary value directly above that with the value of `0xf5b1c153dd6f2500`. To prove that buffer 5 contains that stack canary we can first enter data into buffer location 4 (Figure 12) and print out the values of both 4, 5, and 6.

![image](https://github.com/user-attachments/assets/4942d18a-8ac6-49a1-9bcd-608e598c3d26 align="center")
...
![image](https://github.com/user-attachments/assets/34938321-5f7b-4f85-bb21-8b4f68cc8a89 align="center")
...
![image](https://github.com/user-attachments/assets/1993b886-3c71-4f08-a1cc-b810eea51580 align="center")
...
![image](https://github.com/user-attachments/assets/fbc28f4b-6ace-4454-8fba-54c43af6bdcc align="center")
...
![image](https://github.com/user-attachments/assets/db64d376-5c62-4ef3-a984-25ff3556a9ee align="center")
...
![image](https://github.com/user-attachments/assets/c1a3592c-4482-4297-8e07-d57eaf1d80ca align="center")
...
![image](https://github.com/user-attachments/assets/d0c10e00-d77b-466d-8184-4c5a729c5d67 align="center")
...
![image](https://github.com/user-attachments/assets/364998a8-cf64-4fe1-a5f3-42bd936dff24 align="center")
